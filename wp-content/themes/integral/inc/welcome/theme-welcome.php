...
class integral_welcome {
	...
	public function integral_welcome_register_menu() {
		add_theme_page( __( 'Getting Started with Integral', 'integral' ), __( 'Getting Started with Integral', 'integral' ), 'activate_plugins', 'integral-welcome', array( $this, 'integral_welcome_screen' ) );
	}
	...
	public function integral_welcome_screen() {
        ...
        <div class="wrap about-wrap theme-welcome">
            <h1><?php esc_html_e('Welcome to Integral - Version 1.2.8.2', 'integral'); ?></h1>
